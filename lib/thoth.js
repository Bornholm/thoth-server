...
p._initExpressApp = function(cb) {
    ...
    expressApp.namespace('/api', apiErrorHandler, basicAuthHandler, 
      function() {
        // Base Api
        require('./routes/users')(expressApp, this.api);
        require('./routes/auth')(expressApp, this.api);
        require('./routes/records')(expressApp, this.api);
        require('./routes/roles')(expressApp, this.api);
      }
    );
